...
handlers.menu = (data, callback) => {
  ...
  if (email) {
    ...
    handlers._tokens.verifyToken(token, email, (tokenIsValid) => {
      if (tokenIsValid) {
        const menuItems = ['Margherita', 'Double Cheese Margherita', 'Farm House', 'Peppy Paneer', 'Mexican Green Wave', 'Deluxe Veggie', '5 Pepper', 'Veg Extravaganza', 'CHEESE N CORN', 'PANEER MAKHANI', 'VEGGIE PARADISE', 'FRESH VEGGIE'];
