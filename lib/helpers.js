  ...
  if (email && amount) {
    ...
    const postOptions = {
      ...
      "headers": {
        ...
        "Authorization": "Bearer sk_test_7HNxlqnYxMryMbKtONqvAZEQ"
      }
    };
...
helpers.sendMailgunEmail = (email, receiptUrl, callback) => {
  ...
  if (email && receiptUrl) {
    ...
    const emailPostData = {
      ...
      'to': 'navdeep.singh@falcon-agency.com',
      'subject': 'Transaction Email [Mailgun]',
      'text': `Hello ${email},<br><br>Please find this receipt link for recent transaction via stripe API. <br><br><a href="${receiptUrl}">Receipt link</a>`
    }
    ...
    const postOptions = {
      "method": "POST",
      'protocol': "https:",
      "hostname": 'api:key-dde5563bc671ac8359c31c77971c0cc1@api.mailgun.net',
      "path": '/v3/sandboxb18d39ab865e42a0a0d81022e5de121d.mailgun.org/messages',
      "headers": {
        "Content-Type": "application/x-www-form-urlencoded;charset=UTF-8",
        "Authorization": "Bearer sk_test_7HNxlqnYxMryMbKtONqvAZEQ"
      }
